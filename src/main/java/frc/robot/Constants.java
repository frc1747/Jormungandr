...
public final class Constants {
  ...
  public static class DrivetrainConstants {
    ...
    public static final class FRONT_LEFT { 
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(180-11.7); // was 297.9
    ...
    public static final class FRONT_RIGHT { 
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(124.4); // was 335.8
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class REAR_LEFT { 
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(12.4); // was 266.4 - 180
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class REAR_RIGHT { 
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(180-58.5); // was 95.3 - 180
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  }
